#include "physica/wolfram_physics/hypergraph.h"
...
namespace cnr
{
Hypergraph::Hypergraph() : IdentifiableBase() {}
...
Hypergraph::addEdges(std::vector<std::vector<std::weak_ptr<Node>>> NodeSets)
{
